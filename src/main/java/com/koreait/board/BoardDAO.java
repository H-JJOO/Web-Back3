...
public class BoardDAO {
    public static int insBoard(BoardVO param) {
        ...
        String sql = " INSERT INTO t_board3 (title, ctnt, writer) " +
                " VALUES (?, ?, ?) ";
    ...
    public static int updBoard(BoardVO parma) {
        Connection con = null;
        PreparedStatement ps = null;
        ...
        try {
            con = DbUtils.getCon();
            ps = con.prepareStatement(sql);
            ps.setString(1, parma.getTitle());
            ps.setString(2, parma.getCtnt());
            ps.setString(3, parma.getWriter());
            ps.setInt(4, parma.getIboard());
            return ps.executeUpdate();
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
